...
// Load this file's selection again by visiting: http://mootools.net/more/792e9e0b7354c3b5288dfa9a8faf2342 
// Or build this file again with packager using: packager build More/More More/Date More/Date.Extras More/Fx.Elements More/Fx.Accordion More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Sortables More/Locale More/Locale.Set.From More/Locale.en-US.Date More/Locale.en-US.Form.Validator More/Locale.en-US.Number
/*
---
copyrights:
...
}return(a||a===0)&&a>=0&&a<this.lists.length?b[a]:b;}});(function(){var a={json:JSON.decode};Locale.Set.defineParser=function(b,c){a[b]=c;};Locale.Set.from=function(d,c){if(instanceOf(d,Locale.Set)){return d;
